...
export function brightRed(value: any) {
    return color(ConsoleColor.BrightRed, value);
}

export function brightGreen(value: any) {
    return color(ConsoleColor.BrightGreen, value);
}

export function brightYellow(value: any) {
    return color(ConsoleColor.BrightYellow, value);
}

export function brightBlue(value: any) {
    return color(ConsoleColor.BrightBlue, value);
}

export function brightMagenta(value: any) {
    return color(ConsoleColor.BrightMagenta, value);
}

export function brightCyan(value: any) {
    return color(ConsoleColor.BrightCyan, value);
}

export function brightWhite(value: any) {
    return color(ConsoleColor.BrightWhite, value);
}
